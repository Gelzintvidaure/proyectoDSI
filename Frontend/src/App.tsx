            ...
            <ProtectedRoute>
              <DashboardLayout>
                <div className="p-6">
                  ...
                  <p className="text-gray-500">Página de reportes en desarrollo.</p>
                </div>
              </DashboardLayout>
            </ProtectedRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <DashboardLayout>
                <div className="p-6">
                  <h1 className="text-3xl font-bold text-gray-900 mb-4">Usuarios</h1>
                  <p className="text-gray-500">Página de usuarios en desarrollo.</p>
                </div>
              </DashboardLayout>
            </ProtectedRoute>
          }
        />
        <Route path="/" element={<Navigate to="/dashboard/inventario" replace />} />
